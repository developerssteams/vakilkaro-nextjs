    ...
    if (menu === "license") {
      return (
        <div className="menu-left">
          ...
          <div className="menu-column">
            <p style={{ fontWeight: "bold" }}>Other License</p>
    ...
    <section className="category-section">
      <div className="category-box">
        ...
        <ul className="category-list">
          <li
            onMouseEnter={() => handleMenuEnter("registration")}
          ...
          <li
            onMouseEnter={() => handleMenuEnter("license")}
            onMouseLeave={handleMenuLeave}
          ...
          <li
            onMouseEnter={() => handleMenuEnter("ip")}
            onMouseLeave={handleMenuLeave}
            onClick={() => handleMenuClick("ip")}
          >
            IP & Trademark
          </li>
          <li
            onMouseEnter={() => handleMenuEnter("tax")}
            onMouseLeave={handleMenuLeave}
          ...
          <li
            onMouseEnter={() => handleMenuEnter("gst")}
            onMouseLeave={handleMenuLeave}
            onClick={() => handleMenuClick("gst")}
          >
            GST Filing
          </li>
          <li
            onMouseEnter={() => handleMenuEnter("roc")}
            onMouseLeave={handleMenuLeave}
            onClick={() => handleMenuClick("roc")}
          >
            ROC & Compliance
          </li>
          <li
            onMouseEnter={() => handleMenuEnter("funding")}
            onMouseLeave={handleMenuLeave}
            onClick={() => handleMenuClick("funding")}
          >
            Funding/IPO
          </li>
          <li
            onMouseEnter={() => handleMenuEnter("legal")}
            onMouseLeave={handleMenuLeave}
        ...
        {activeMenu && !isMobile && (
          ...
          >
            <MobileMenuContent menu={activeMenu} />
          </div>
        )}
